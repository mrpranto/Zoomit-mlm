        ...
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown d-none d-lg-inline-block">
                <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-toggle="fullscreen" href="#">
                    <i class="fe-maximize-2 noti-icon"></i>
                </a>
            </li>
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    @if (optional(optional(auth()->user())->profilePicture)->path)
                        <img src="{{ auth()->user()->profilePicture->full_url }}" alt="user-image" class="rounded-circle">
                    @else
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                   ...
                   @can('app.profile.Update')
                    ...
                    <a href="{{ route('profile') }}?user={{ auth()->user()->id }}&tabs=personal_info" class="dropdown-item notify-item">
                        <i class="fe-user"></i>
                   ...
                   @can('app.setting.index')
                    ...
                    <a href="{{ route('setting.index') }}?tabs=general" class="dropdown-item notify-item">
